...
public enum STTEvent: Equatable, Sendable {
  ...
  /// One word of a partial, with its timing. Every field except the word itself is optional,
  /// since nothing here depends on timings and the endpoint is free to omit them.
